...
const ListActor = ({ id }) => {
    ...
    useEffect(() => {
        const fetchActors = async () => {
            try {
                const response = await axios.get(`http://localhost:5000/api/actors/list/${id}`);
    ...
    return (
        <div className="actor-list-container d-flex justify-content-center align-items-center">
            <button 
